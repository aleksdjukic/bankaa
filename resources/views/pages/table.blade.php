...
<div id="app">
    ...
    <section>
        <div class="container">
            <table>
                <tr>
                    <th rowspan="3">Iznos/Kamatna stopa</th>
                    <th colspan="4">Rok (godina)</th>
                </tr>
                ...
                <tr>
                    <td>EKS* - Nenamjenski kredit</td>
                    <td>6,33% (RS i FBiH)</td>
                    <td>6,08% (RS i FBiH)</td>
                    <td>6,23% (RS i FBiH)</td>
                    <td>6,04% (RS i FBiH)</td>
                </tr>

                <tr>
                    <td>EKS* - Zamjenski kredit</td>
                    <td>5,99% (RS i FBiH)</td>
                    <td>5,91% (RS i FBiH)</td>
                    <td>6,04% (RS i FBiH)</td>
                    <td>5,90% (RS i FBiH)</td>
                </tr>
