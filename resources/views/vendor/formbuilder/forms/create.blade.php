                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="title_sr" type="text" class="form-control{{ $errors->has('title_sr') ? ' is-invalid' : '' }}" name="title_sr" value="{{ old('title_sr') }}" required autofocus placeholder="Enter Serbian Title">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="title_en" type="text" class="form-control{{ $errors->has('title_en') ? ' is-invalid' : '' }}" name="title_en" value="{{ old('title_en') }}" required autofocus placeholder="Enter English Title">
