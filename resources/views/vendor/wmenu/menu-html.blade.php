...
{{--                    <label for="menu" class="selected-menu" style="padding: 10px;margin: 0">Select the menu you want to--}}
{{--                        edit:</label>--}}

{{--                    {!! Menu::select('menu', $menulist) !!}--}}

{{--                    <span class="submit-btn">--}}
{{--										<input type="submit" class="button-secondary width-auto" value="Choose"/>--}}
{{--									</span>--}}
...
<div class="main-body">
    <div id="hwpwrap" class="container sec-background">
        <div class="custom-wp-admin wp-admin wp-core-ui js   menu-max-depth-0 nav-menus-php auto-fold admin-bar">
            <div id="wpwrap">
                <div id="wpcontent">
                    <div id="wpbody" style="padding: 0px 60px 60px 60px;">
                                                    ...
                                                    <ul class="outer-border">
                                                        <li class="control-section accordion-section  open add-page"
                                                            ...
                                                            <h3 class="accordion-section-title hndle" tabindex="0">
                                                                Prilagođena veza <span class="screen-reader-text">Press return or enter to expand</span>
                                                            </h3>
                                                                ...
                                                                <div class="inside">
                                                                    <div class="customlinkdiv" id="customlinkdiv">
                                                                        <p id="menu-item-name-wrap">
                                                                            <label class="howto"
                                                                                   for="custom-menu-item-name"> <span>Label</span>&nbsp;
                                                                        ...
                                                                        <p id="menu-item-name-wrap">
                                                                            <label class="howto"
                                                                                   for="custom-menu-item-name"> <span>Label</span>&nbsp;
                                                                                <input id="custom-menu-item-name-en"
                                                                                       name="label_en" type="text"
                                                                                       class="regular-text menu-item-textbox input-with-default-title"
                                                                                       title="Ime stranice Engleski">
                                                                            </label>
                                                                        </p>
                                                                        ...
                                                                        <p id="menu-item-url-wrap">
                                                                            <label class="howto"
                                                                                   for="custom-menu-item-url">
                                                                                <span>URL EN</span>&nbsp;&nbsp;&nbsp;
                                                                                <input id="custom-menu-item-url-en"
                                                                                       name="url_en" type="text"
                                                                                       class="menu-item-textbox "
                                                                                       placeholder="url_en">
                                                                            </label>
                                                                        </p>
...
{{--                                                                </div>--}}
                                                    ...
                                                    <div id="post-body">
                                                        <div id="post-body-content">
                                                            ...
                                                            @if(request()->has("menu"))
                                                                <h3>Struktura Menija</h3>
                                                                <div class="drag-instructions post-body-plain" style="">
                                                                    <p>
                                                                        Stavite svaku stavku onako kako želite.
                                                                        Kliknite strelicu s desne strane stavke da biste prikazali više opcija konfiguracije..
                                                                    </p>
                                                                </div>
                                                                        ...
                                                                        <li id="menu-item-{{$m->id}}"
                                                                            ...
                                                                            <dl class="menu-item-bar">
                                                                                <dt class="menu-item-handle">
                                                                                    <span class="item-title"> <span
                                                                                            ...
                                                                                            class="is-submenu"
                                                                                            style="@if($m->depth==0)display: none;@endif">Podelement</span> </span>
                                                                                    <span class="item-controls"> <span
                                                                                            class="item-type">Veza</span> <span
                                                                            ...
                                                                            <div class="menu-item-settings"
                                                                                ...
                                                                                <p class="field-move hide-if-no-js description description-wide">
                                                                                    <label> <span>Pomjeri</span> <a
                                                                                            href="{{ $currentUrl }}"
                                                                                            class="menus-move-up"
                                                                                            style="display: none;">Pomjeri gore</a> <a
                                                                                            href="{{ $currentUrl }}"
...
{{--                                                                                        </a>--}}
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <a class="item-delete submitdelete deletion"
                                                                                       id="delete-{{$m->id}}"
                                                                                       href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Obriši</a>
                                                                                    <span
                                                                                        class="meta-sep hide-if-no-js"> | </span>
                                                                                    <a class="item-cancel submitcancel hide-if-no-js button-secondary"
                                                                                       id="cancel-{{$m->id}}"
                                                                                       href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Odustani</a>
                                                                                    <span
                                                                                        class="meta-sep hide-if-no-js"> | </span>
                                                                                    <a onclick="getmenus()"
                                                                                       class="button button-primary updatemenu"
                                                                                       id="update-{{$m->id}}"
                                                                                       href="javascript:void(0)">Ažuriraj stavku</a>
