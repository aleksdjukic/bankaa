                    ...
                    <form action="{{ route('formbuilder::forms.update', $form) }}" method="POST" id="createFormForm" data-form-method="PUT">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="title_sr" class="col-form-label">Title [SR]</label>

                                        <input id="title_sr" type="text" class="form-control{{ $errors->has('title_sr') ? ' is-invalid' : '' }}" name="title_sr" value="{{ old('title_sr') ?? $form->title_sr }}" required autofocus placeholder="Enter Serbian Title">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="title_en" type="text" class="form-control{{ $errors->has('title_en') ? ' is-invalid' : '' }}" name="title_en" value="{{ old('title_en') ?? $form->title_en }}" required autofocus placeholder="Enter English Title">
...
<script src="{{ asset('public/vendor/formbuilder/js/create-form.js') }}{{ jazmy\FormBuilder\Helper::bustCache() }}" defer></script>
@endpush
