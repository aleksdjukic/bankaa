...
@section('title')
    ADMIN | KATEGORIJE NOVOSTI
@endsection
@section('admin-content')
    <div class="filter-bar">
        <div class="container">
            <div class="filter-side">
                LISTA KATEGORIJA NOVOSTI
            </div>
    ...
    <div class="main-body">
        <div class="container sec-background">
            <div class="head-content">
                ...
                <a href="{{ route('category-news.create') }}" class="add-list tooltip" tooltip="Dodaj">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="edit-article tooltip" tooltip="Uredi">
                                    <a href="{{ route('category-news.edit', $sve->id) }}">
                                ...
                                <div class="delete-article tooltip" tooltip="Obriši">
                                    ...
                                    <form class='forma' method="POST" id="form_{{$sve->id}}" action="{{route('category-news.destroy', $sve->id)}}">
