@extends('layouts.admin', ['kategorijeImovine' => true])
@section('title')
    ADMIN | KATEGORIJE IMOVINE
@endsection
@section('admin-content')
    <div class="filter-bar">
        <div class="container">
            <div class="filter-side">
                LISTA KATEGORIJA IMOVINE
            </div>
    ...
    <div class="main-body">
        <div class="container sec-background">
            <div class="head-content">
                <p>KATEGORIJE IMOVINE</p>
                <a href="{{ route('category-properties.create') }}" class="add-list tooltip" tooltip="Dodaj">
            ...
            <div class="main-body-list">
                <table>
                    ...
                    @foreach ($categoryProperty as $sve)
                        <tr>
                            <td>{{ $br++ }}</td>
                            <td>{{ $sve->name }}</td>
                            ...
                            <td>
                                <div class="edit-article tooltip" tooltip="Uredi">
                                    <a href="{{ route('category-properties.edit', $sve->id) }}">
                                ...
                                <div class="delete-article tooltip" tooltip="Obriši">
                                    <form class='forma' method="POST" id="form_{{$sve->id}}"
                                          action="{{route('category-properties.destroy', $sve->id)}}">
...
{{--                    <div class="arrows">--}}
{{--                        <a>--}}
{{--                            <img src="{{ asset('images/icons8_Down_Arrow_96px_1.svg') }}" alt="left"/>--}}
{{--                        </a>--}}
{{--                        <a>--}}
{{--                            <img src="{{ asset('images/icons8_Down_Arrow_96px_1.svg') }}" alt="right"/>--}}
{{--                        </a>--}}
{{--                    </div>--}}
                </div>
            </div>
