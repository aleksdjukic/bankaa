...
{{--@endsection--}}
@if($layoutId == 1)
    @include('admin.pages.templates.create-template1')
@elseif($layoutId == 2)
    @include('admin.pages.templates.create-template2')
@elseif($layoutId == 3)
    @include('admin.pages.templates.create-template3')
@elseif($layoutId == 4)
    @include('admin.pages.templates.create-template4')
@elseif($layoutId == 5)
    @include('admin.pages.templates.create-template5')
@endif
